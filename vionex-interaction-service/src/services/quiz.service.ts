...
export class QuizService {
  ...
  createQuiz(
    ...
    console.log('[QuizService] Creating quiz:', {
      roomId,
      title,
    ...
    console.log('[QuizService] Quiz created:', {
      quizId,
      roomId,
      title,
      creatorId,
  ...
  submitQuiz(
    ...
    answers.forEach((answer) => {
      ...
      if (question.type === 'essay') {
        ...
        isCorrect = question.correctAnswers?.includes(selectedOption) || false;
  ...
  getQuizResults(roomId: string, quizId: string): QuizSession | null {
    ...
    console.log('[QuizService] Quiz results found:', { quizId, roomId });
    return quizSession;
  }
  ...
  cleanupRoom(roomId: string) {
    ...
    quizzesToRemove.forEach((quizId) => {
      ...
      console.log('[QuizService] Removed quiz:', { quizId });
    });
