...
export class InteractionController {
    ...
    try {
      ...
      return {
        ...
        whiteboard_data: {
          ...
          allowed_users:
            this.whiteboardService.getPermissions(data.room_id).allowed_users ||
            [],
          updated_at: result.updatedAt,
        },
      };
    } catch (error) {
      console.error('[InteractionController] UpdateWhiteboard error:', error);
      return {
        success: false,
        error: error.message,
      };
  ...
  async getWhiteboardData(data: { room_id: string }) {
    try {
      ...
      const permissions = this.whiteboardService.getPermissions(data.room_id);
      ...
      return {
        ...
        whiteboard_data: whiteboardData
          ? {
              ...
              updated_at: whiteboardData.updatedAt || new Date().toISOString(),
            }
          : {
              room_id: data.room_id,
              elements: [],
      ...
      console.error('[InteractionController] GetWhiteboardData error:', error);
      return {
        success: false,
        whiteboard_data: {
          room_id: data.room_id,
  ...
  async updatePermissions(data: { room_id: string; allowed_users: string[] }) {
    try {
      ...
      console.error('[InteractionController] UpdatePermissions error:', error);
      return {
        success: false,
        allowed_users: [],
      };
  ...
  async getPermissions(data: { room_id: string }) {
    try {
      ...
      console.error('[InteractionController] GetPermissions error:', error);
      return {
        success: false,
        allowed_users: [],
      };
  ...
  async getVoteResults(data: { room_id: string; vote_id: string }) {
    try {
      ...
      console.error('[InteractionController] Error getting vote results:', {
        error: error.message,
        stack: error.stack,
        data,
      });
  ...
  async getActiveVote(data: { room_id: string }) {
    try {
      ...
      console.error('[InteractionController] Error getting active vote:', {
        error: error.message,
        stack: error.stack,
        data,
      });
  ...
  async createQuiz(data: {
    ...
    try {
      ...
      console.error('[InteractionController] Error creating quiz:', error);
      return {
        success: false,
        error: error.message,
      };
  ...
  async submitQuiz(data: {
    ...
    try {
      ...
      console.error('[InteractionController] Error submitting quiz:', error);
      return {
        success: false,
        total_score: 0,
  ...
  async saveUserBehavior(data: {
    ...
    try {
      ...
      console.error('[InteractionController] SaveUserBehavior error:', error);
      return {
        success: false,
        error: error.message,
      };
  ...
  async setBehaviorMonitorState(data: { room_id: string; is_active: boolean }) {
    try {
  ...
  async clearRoomLogs(data: { room_id: string }) {
    try {
      ...
      console.error('[InteractionController] ClearRoomLogs error:', error);
      return { success: false };
    }
  }
